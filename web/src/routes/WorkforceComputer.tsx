...
export function Computer({ project }: { project: Project }) {
  ...
  return <div className="wf-computer">
    ...
    <section className="wf-panel wf-form"><h2>Teach a routine</h2><p>Take control and record a demonstration. Text entry is redacted into manual checkpoints by default. In the draft editor you can explicitly review harmless replay values for search and forms; password/login fields always remain manual. URL query strings become manual checkpoints too.</p>
