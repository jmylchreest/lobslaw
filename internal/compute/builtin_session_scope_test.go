...
func runSessionToolTurn(t *testing.T, browser *fakeBrowser, claims *types.Claims, channel, chatID, tool, args string) ToolInvocation {
	t.Helper()
	env := newAgentEnv(t,
		MockResponse{ToolCalls: []ToolCall{{ID: "call-1", Name: tool, Arguments: args}}},
