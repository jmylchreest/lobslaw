...
func SoulToolDefs() []*types.ToolDef {
	return []*types.ToolDef{
		...
		{
			Name:        "soul_tune",
			Path:        compute.BuiltinScheme + "soul_tune",
		...
		},
		{
			...
			Path:        compute.BuiltinScheme + "soul_fragment_add",
		...
		},
		{
			...
			Path:        compute.BuiltinScheme + "soul_fragment_remove",
		...
		},
		{
			...
			Path:        compute.BuiltinScheme + "soul_history_rollback",
...
func soulTuneHandler(m SoulMutator) compute.BuiltinFunc {
...
func soulFragmentAddHandler(m SoulMutator) compute.BuiltinFunc {
	return func(ctx context.Context, args map[string]string) ([]byte, int, error) {
...
func soulFragmentRemoveHandler(m SoulMutator) compute.BuiltinFunc {
	return func(ctx context.Context, args map[string]string) ([]byte, int, error) {
...
func soulHistoryRollbackHandler(m SoulMutator) compute.BuiltinFunc {
	return func(ctx context.Context, args map[string]string) ([]byte, int, error) {
		steps := 1
