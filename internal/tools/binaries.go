...
func BinariesToolDefs() []*types.ToolDef {
	return []*types.ToolDef{
		{
			Name:        "binary_list",
			Path:        compute.BuiltinScheme + "binary_list",
		...
		{
			Name:        "binary_install",
			Path:        compute.BuiltinScheme + "binary_install",
...
func newBinaryListHandler(cfg BinariesConfig) compute.BuiltinFunc {
...
func newBinaryInstallHandler(cfg BinariesConfig) compute.BuiltinFunc {
