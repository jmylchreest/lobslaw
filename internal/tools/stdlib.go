...
func StdlibToolDefs() []*types.ToolDef {
	return []*types.ToolDef{
		{
			Name:        "current_time",
			Path:        compute.BuiltinScheme + "current_time",
		...
		{
			Name:        "read_file",
			Path:        compute.BuiltinScheme + "read_file",
		...
		{
			Name:        "list_files",
			Path:        compute.BuiltinScheme + "list_files",
		...
		{
			Name:        "glob",
			Path:        compute.BuiltinScheme + "glob",
		...
		{
			Name:        "grep",
			Path:        compute.BuiltinScheme + "grep",
