...
func CredentialsToolDefs() []*types.ToolDef {
	return []*types.ToolDef{
		{
			Name:        "oauth_start",
			Path:        compute.BuiltinScheme + "oauth_start",
		...
		{
			Name:        "oauth_status",
			Path:        compute.BuiltinScheme + "oauth_status",
		...
		{
			Name:        "oauth_revoke",
			Path:        compute.BuiltinScheme + "oauth_revoke",
		...
		},
		{
			...
			Path:        compute.BuiltinScheme + "credentials_grant",
		...
		},
		{
			...
			Path:        compute.BuiltinScheme + "credentials_revoke",
...
func newOAuthStartHandler(cfg CredentialsConfig) compute.BuiltinFunc {
...
func newOAuthStatusHandler(cfg CredentialsConfig) compute.BuiltinFunc {
...
func newOAuthRevokeHandler(cfg CredentialsConfig) compute.BuiltinFunc {
	return func(ctx context.Context, args map[string]string) ([]byte, int, error) {
...
func newCredentialsGrantHandler(cfg CredentialsConfig) compute.BuiltinFunc {
	return func(ctx context.Context, args map[string]string) ([]byte, int, error) {
		provider := strings.TrimSpace(args["provider"])
		subject := strings.TrimSpace(args["subject"])
...
func newCredentialsRevokeHandler(cfg CredentialsConfig) compute.BuiltinFunc {
	return func(ctx context.Context, args map[string]string) ([]byte, int, error) {
		provider := strings.TrimSpace(args["provider"])
		subject := strings.TrimSpace(args["subject"])
		skill := strings.TrimSpace(args["skill"])
