	...
	return []*types.ToolDef{
		{
			...
			Path:        compute.BuiltinScheme + "commitment_create",
		...
		},
		{
			...
			Path:        compute.BuiltinScheme + "commitment_list",
		...
		},
		{
			...
			Path:        compute.BuiltinScheme + "commitment_cancel",
...
func newCommitmentCreateHandler(raft memoryRaftApplier) compute.BuiltinFunc {
...
func newCommitmentListHandler(store *memory.Store) compute.BuiltinFunc {
	return func(ctx context.Context, args map[string]string) ([]byte, int, error) {
...
func newCommitmentCancelHandler(store *memory.Store, raft memoryRaftApplier) compute.BuiltinFunc {
	return func(ctx context.Context, args map[string]string) ([]byte, int, error) {
