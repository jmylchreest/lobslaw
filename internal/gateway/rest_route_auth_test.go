...
func restRouteAuthTable() map[string]restRouteClass {
	return map[string]restRouteClass{
		...
		"/v1/tools":        restRouteUserData,
		"/v1/computers/":   restRouteUserData,
...
func TestUnauthenticatedCallerGets401OnEveryUserDataRoute(t *testing.T) {
	...
	probes := []struct {
		...
		{http.MethodGet, "/v1/computers/project", ""},
		{http.MethodPost, "/v1/computers/project", `{"action":"takeover"}`},
		{http.MethodGet, "/v1/computers/project/screenshot", ""},
