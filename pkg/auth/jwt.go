...
func NewValidator(cfg Config) (*Validator, error) {
	...
	if cfg.AllowHS256 {
		if len(cfg.HS256Secret) < minHS256SecretBytes {
			return nil, fmt.Errorf("auth: allow_hs256=true requires an HS256 secret of at least %d bytes", minHS256SecretBytes)
		}
